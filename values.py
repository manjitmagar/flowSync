...
class BoxValues:
    ...
    def draw_boxes(self, screen):
        ...
        self.render_and_blit_text(screen, "Lane A", self.vehicle_count_a1, self.box_a1)
        self.render_and_blit_text(screen, "Lane A", self.vehicle_count_a2, self.box_a2)
        self.render_and_blit_text(screen, "Lane B", self.vehicle_count_b1, self.box_b1)
        self.render_and_blit_text(screen, "Lane B", self.vehicle_count_b2, self.box_b2)
